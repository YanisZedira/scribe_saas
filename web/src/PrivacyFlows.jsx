...
export function PublicConsent({ token }) {
  ...
  return <PublicShell>
    ...
    <ul className="notice-list">
      ...
      <li>{notice.media_recording_enabled ? `Le replay audio sera supprimé automatiquement après ${notice.media_retention_days} jour${notice.media_retention_days > 1 ? "s" : ""}.` : "L’audio sera supprimé après le traitement."}</li>
